class Mock {
  static const splashVideo = "https://youtu.be/zTFmgNjx4EM?si=b4KfLvpjWlFu3mUh";
  ...
  static final words = [
    {
      ...
      "name": "Café",
      "meaning":
          "Bebida feita a partir dos grãos torrados do cafeeiro, muito consumida em diversas culturas.",
      "video": "https://youtu.be/IBeRE0a5jiY?si=7qG_4uVg2biMejqQ"
    },
    {
      "id": 2,
      "name": "Cidade",
      ...
      "video": "https://youtu.be/G0ZAUtfLtjA?si=tmThMuc5eq3dFABI"
    },
    {
      "id": 3,
      "name": "Conhecimento",
      "meaning":
          "Conjunto de informações, aprendizagens e experiências adquiridas ao longo da vida.",
      "video": "https://youtu.be/qVQlGIdd6-w?si=llesa6sSUbmLaZE3"
    },
    {
      "id": 4,
      "name": "Cultura",
      "meaning":
          "Complexo que inclui conhecimento, crenças, arte, morais, leis, costumes e outras aptidões e hábitos adquiridos pelo homem como membro da sociedade.",
      "video": "https://youtu.be/amK4eK53OE0?si=gDKOJ4qmC1enMzsl"
    },
    {
      "id": 5,
      "name": "Democracia",
      "meaning":
          "Regime político em que o poder é exercido pelo povo, direta ou indiretamente, através de representantes eleitos.",
      "video": "https://youtu.be/qUqOg9SK6j8?si=w87PXCphMqK5hH1h"
    },
    {
      "id": 6,
      "name": "Ditadura",
      "meaning":
          "Regime político autoritário em que o poder está concentrado nas mãos de um líder ou grupo, sem participação democrática.",
      "video": "https://youtu.be/ZAPelC5fXik?si=3gYr6kPiQc1BhkoQ"
    },
    {
      "id": 7,
      "name": "Eleição",
      "meaning":
          "Processo de escolha de representantes políticos por meio do voto.",
      "video": "https://youtu.be/r6Gu2TCdOSA?si=5YYZZp5wAJTAW4Ah"
    },
    {
      "id": 8,
      "name": "Ética",
      ...
      "video": "https://youtu.be/XxdFq32PDhI?si=9Oyn-Df_PFZX2GBl"
    },
    {
      "id": 9,
      "name": "Fábrica",
      "meaning":
          "Local onde se produzem bens ou produtos a partir de matérias-primas, geralmente de forma industrial.",
      "video": "https://youtu.be/gl_DhHQ40yc?si=ZNXum4HF2rfBT93T"
    },
    {
      "id": 10,
      "name": "Família",
      "meaning":
          "Grupo de pessoas unidas por laços de parentesco, afeto ou convivência.",
      "video": "https://youtu.be/Eaa96J9yHxg?si=eneWRNM0OM_FCq3O"
    },
    {
      "id": 11,
      "name": "Fogo",
      "meaning": "Reação química de combustão que libera calor e luz.",
      "video": "https://youtu.be/qMHc_GVbrY4?si=AvXTBYCUds2c3EzS"
    },
    {
      "id": 12,
      "name": "Governo",
      "meaning":
          "Sistema de administração de um Estado ou nação, responsável pela criação e execução de leis.",
      "video": "https://youtu.be/c_cie8_croI?si=cdZzM_oRM000MJ0l"
    },
    {
      "id": 13,
      "name": "Guerra",
      "meaning": "Conflito armado entre nações, grupos ou facções políticas.",
      "video": "https://youtu.be/RKL2tcQzXQM?si=VfM8BZBubLGAa61j"
    },
    {
      "id": 14,
      "name": "História",
      "meaning":
          "Estudo dos acontecimentos do passado e sua influência no presente.",
      "video": "https://youtu.be/BD0Nk0OBHIo?si=nMOsAqIoFrl7d5k0"
    },
    {
      "id": 15,
      "name": "Idade Antiga",
      "meaning":
          "Período da história que compreende desde o surgimento da escrita até a queda do Império Romano do Ocidente (476 d.C.).",
      "video": "https://youtu.be/zPCDTiJQUyM?si=qxA5lrpfptgXCfQO"
    },
    {
      "id": 16,
      "name": "Idade Média",
      "meaning":
          "Período da história compreendido entre os séculos V e XV, marcado pelo feudalismo e pela influência da Igreja Católica.",
      "video": "https://youtu.be/Amedvr-1KNk?si=kpsCpgb0Yq2kT_9N"
    },
    {
      "id": 17,
      "name": "Leite",
      "meaning":
          "Líquido branco produzido pelas glândulas mamárias dos mamíferos, consumido como alimento.",
      "video": "https://youtu.be/9HgxSa1hGHE?si=97b4HNGTc_wRJ2Yt"
    },
    {
      "id": 18,
      "name": "Lutar",
      "meaning":
          "Empreender esforço físico ou mental para alcançar um objetivo ou superar dificuldades.",
      "video": "https://youtu.be/8xu81S0UpCQ?si=OJUzDmhVfNMRuzOt"
    },
    {
      "id": 19,
      "name": "Política",
      "meaning":
          "Arte ou ciência de governar, que envolve a administração pública e as relações de poder em uma sociedade.",
      "video": "https://youtu.be/yf8AKUwuKBY?si=K6EXdnAPBTh3hNv7"
    },
    {
      "id": 20,
      "name": "Teatro",
  ...
  static final epochs = [
    ...
    {"id": 2, "name": "Idade Antiga"},
    {"id": 3, "name": "Idade Média"},
    {"id": 4, "name": "Idade Moderda"},
    {"id": 5, "name": "Idade Contemporânea"}
  ];
  static final genres = [
    {"id": 1, "name": "Guerras"},
    {"id": 2, "name": "Revoluções"},
    {"id": 3, "name": "Desastes"}
  ];
  static final abouts = [
    {
